...
Leveraging the Health Information National Trends Survey data from the National Cancer Institute, this research addresses three key areas of inquiry. First, it examines demographic and socio-economic factors—such as age, gender, ethnicity, education, and income—to uncover patterns in telehealth utilization and potential disparities in digital health engagement. Second, it explores social media usage patterns and engagement levels with health information, comparing these between telehealth users and non-users to understand how health information seeking on social media is associated with telehealth utilization. Finally, the study investigates cancer risk perception among telehealth users and non-users to analyze how health awareness is related to telehealth utilization. By integrating these dimensions, the research provides a comprehensive perspective on the drivers of telehealth adoption and their implications for enhancing digital health equity and improving public health outcomes.
...
## Methods
(please explain what data we used, when it was collected, by whom etc...). For this project, program R created by @r was used for data analysis. Then R packages such as tidyverse [@tidyverse], here [@here], and rio [@rio] were applied.
