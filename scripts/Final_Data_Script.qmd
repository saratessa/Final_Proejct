...
The increasing adoption of telehealth services has transformed healthcare delivery by offering more accessible and convenient solutions for diverse health needs [@weinstein]. However, ensuring equitable access to these services requires a deeper understanding of the characteristics that influence their utilization. This study focuses on identifying and analyzing demographic, socio-economic, and behavioral factors that differentiate telehealth users from non-users with an exploratory object regarding this matter. By examining these factors, the study seeks to provide rudimentary insights into how telehealth can better serve diverse populations.

Leveraging the Health Information National Trends Survey data from the National Cancer Institute, this research addresses three key areas of inquiry. First, it examines demographic and socio-economic factors—such as age, gender, ethnicity, education, and income—to uncover patterns in telehealth utilization and potential disparities in digital health engagement because individual characteristics could serve as barriers or facilitators for telehealth access. Second, it explores social media usage patterns and engagement levels with health information, comparing these between telehealth users and non-users. Given the growing role of social media as a source of health information, social media usage and activities regarding health information could be some meaningful factors in understanding people's willingness to adopt the digital healthcare service.  Finally, the study investigates cancer risk perception among telehealth users and non-users to analyze how health awareness is related to telehealth utilization. Since telehealth can be an effective tool for health care or education, grasping how people perceive their cancer risk could help tailor telehealth services to meet the needs of different groups of people. By integrating these dimensions, the research could contribute to a deeper understanding of the telehealth adoption and their role in enhancing digital health equity for public health.
